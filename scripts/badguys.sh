...
aws s3 cp s3://$2-ransomware-bucket-$3/awsimmersionday/app/app.zip s3://$2-ransomware-bucket-$3/awsimmersionday/app/app.zip --sse aws:kms --sse-kms-key-id arn:aws:kms:us-west-2:911290716430:key/e1583228-d021-4f40-b83b-52fd722074e9
aws eks --region $1 update-kubeconfig --name $2-eks-$3
